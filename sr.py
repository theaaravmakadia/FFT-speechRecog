...
# Retrieve data from https://www.kaggle.com/kongaevans/speaker-recognition-dataset/download
# Save it to the 'Downloads' folder in your HOME directory
...
# The factor to multiply the noise
SCALE = 0.5
...
# Logistics surrounding potential errors prior to the learning model
...
"""
## Noise preparation --> load noise samples and split to chunks of 16000 samples which
...
"""
Now, resample noise samples to 16000 Hz
"""
...
# Noise is split into chunks of 16,000 steps each
...
def paths_and_labels_to_dataset(audio_paths, labels):
    """Building dataset of audios and labels."""
...
# Generate list of audio file paths along with corresponding labels
